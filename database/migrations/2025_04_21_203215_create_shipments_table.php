...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('shipments', function (Blueprint $table) {
            ...
            $table->foreignId('origin_agency_id')->nullable()->constrained('agencies')->onDelete('cascade');
            $table->foreignId('destination_agency_id')->nullable()->constrained('agencies')->onDelete('cascade');
